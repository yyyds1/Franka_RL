...
class HandDatasetSAPIENViewer:
    ...
    def _load_object(self, obj_id, obj_mesh_file):
        builder = self.scene.create_actor_builder()
        builder.add_visual_from_file(obj_mesh_file)
        actor = builder.build_static(name=obj_id)
    ...
    def render_data(self, data: Dict, fps=10):
